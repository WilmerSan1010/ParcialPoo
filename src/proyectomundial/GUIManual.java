...
public class GUIManual extends JFrame {
    ...
    private JLabel btonSesion;
    private JPanel jPanelSesion;
    private JLabel usuario;
    private JLabel contra;
    private JPanel sesionInicio;
    ...
    private void menuSesion() {
        btonSesion.setIcon(new ImageIcon(getClass().getResource("/resources/icons/home.png"))); // NOI18N
        btonSesion.setText("SESION");
        btonSesion.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jPanelSesion.add(SESION, BorderLayout.WEST);
        jPanelSesion.add(btonSesion, BorderLayout.CENTER);
    ...
    private void accionSesion() {
        ...
        String textoUser = JOptionPane.showInputDialog(null, "Ingresa el usuario :");
